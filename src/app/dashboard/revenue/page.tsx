...
export default function RevenueManagement() {
  ...
  const fetchRevenueData = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/premium/admin/revenue?period=${selectedPeriod}`);
  ...
  const fetchTransactions = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/premium/admin/transactions`);
      const data = await response.json();
